...
In einer der wissenschaftlichen Veröffentlichungen von "Greene" wird ein alternatives Verfahren für die bisher bekannten Split-Methoden vorgestellt. Die Idee besteht darin, die Polygone nach der jeweiligen Achse zu sortieren, in der die größte Ausbreitung ermittelt wird. Auf Basis dieser Sortierung hat man nun eine Reihe Splits, aus denen dann der Algorithmus den Favoriten ermittelt und übernimmt. Das Ergebniss in \Cref{fig:beispiel-greenes-split} rechts stellt den Favoriten dar mit der gerinsten Flächensumme. Neben dem besagten Flächenkriterium besitzt der GreenesSplit() im Vergleich zu den anderen Split-Algorithmen ein zusätzliches, geometrisches Kriterium: die Verteilung der Geometrien im Raum und die daraus ermittelte Trenn-Achse - wobei es auch hier zu Situationen kommen kann, in der sich der GreenesSplit() für die "falsche" Achse entscheidet. Es existieren allerdings noch weitere Kriterien, die im nächsten Kapitel aufgezählt werden, womit man die Verteilung im R-Baum optimieren könnte. 
